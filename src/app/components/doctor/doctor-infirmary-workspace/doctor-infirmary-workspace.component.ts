...
//    });*/
  ...
  goToMedicalRecord(): void {
    this.saveFormData();
    this.router.navigate(['doctor-infirmary-medical-record', this.lbp]);
  }
  ...
  goToStateHistory(): void {
    ...
    console.log(this.lbp);
    this.saveFormData();
    this.router.navigate(['doctor-infirmary-state-history', this.lbp]);
  }
  ...
  goToMedicalChart(): void {
    ...
    console.log(this.lbp);
    this.saveFormData();
    this.router.navigate(['doctor-infirmary-medical-chart', this.lbp]);
  }
  ...
  goToDischargeList(): void {
    ...
    console.log(this.lbp);
    this.saveFormData();
    this.router.navigate(['doctor-infirmary-discharge-list', this.lbp]);
  }
