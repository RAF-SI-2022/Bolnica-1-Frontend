...
@Component({
  selector: 'app-doctor-create-referral-new',
  templateUrl: './doctor-create-referral-new.component.html',
  styleUrls: ['./doctor-create-referral-new.component.css']
})
export class DoctorCreateReferralNewComponent implements OnInit{
